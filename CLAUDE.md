...
| `SLOVE_VoiceCategories` | `Hidden`. Static tables: `MaleOnlyRemap`, `AllFemaleCategories` (75), `AllMaleCategories` (15). Category names are AudioUtil folder names — no Sound forms or voice aliases exist anywhere |
